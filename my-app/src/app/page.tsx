            ...
            <div className="flex h-[100vh] pt-24">
                ...
                <div ref={heroRef} className="w-2/3 flex flex-col items-center justify-center text-center px-6">
                    <h1 className="text-6xl font-extrabold text-white shadow-md">
                        Empowering your blockchain projects with real-world data—your <span className="text-purple-300">Chainlink</span> AI assistant!
                    </h1>
                </div>
            ...
            <div ref={descriptionRef} className="absolute w-1/2 mx-auto top-[80vh] left-16 p-6">
                ...
                >
                    ...
                    <p className="mt-4 text-xl leading-relaxed text-gray-300">
                        ...
                        <br />
                        <br />
                        👉“How does Chainlink connect smart contracts to real-world data?”<br />
                        👉“What are the benefits of using decentralized oracles?”<br />
                        👉“Can you explain how LINK tokens are used in the Chainlink network?”<br />
                        👉“What are some use cases for Chainlink in decentralized finance?”<br />
                        👉“How does Chainlink ensure data integrity and reliability?”<br />
                        👉“What should I know about integrating Chainlink with my dApp?”<br />
                        <br />
